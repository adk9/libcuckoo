...
public:
    ...
    public:
        ...
        public:
            ...
            const hashtable_t::value_type& operator*() const {
                check_table();
            ...
            const_iterator& operator++() {
                check_table();
                if (index_ >= parent_ti_->buckets_.size()) {
                    throw std::out_of_range(
                        "Cannot increment iterator past the end");
                }
                ...
                // set slot_ to 0
                assert(index_ == parent_ti->buckets_.size());
                slot_ = 0;
                return *this;
            }
            ...
            const_iterator& operator--() {
                ...
                // move before that, we throw an exception
                for (; index_ >= 0; --index_) {
                    while (--slot_ >= 0) {
                        if (parent_ti_->buckets_[index_].occupied(slot_)) {
                            return *this;
                ...
                throw std::out_of_range(
                    "Cannot decrement iterator before the beginning");
            }
        ...
        protected:
            ...
            hashtable_t::TableInfo* parent_ti_;
        ...
        public:
            ...
            hashtable_t::value_type& operator*() const {
